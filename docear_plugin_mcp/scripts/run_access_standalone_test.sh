...
"$JAVA_HOME/bin/javac" -encoding UTF-8 -source 1.8 -target 1.8 -d "$BUILD" \
  ...
  "$ROOT/src/org/docear/plugin/mcp/json/JsonParser.java" \
  "$ROOT/src/org/docear/plugin/mcp/server/McpRole.java" \
  "$ROOT/src/org/docear/plugin/mcp/server/McpPrincipal.java" \
  "$ROOT/src/org/docear/plugin/mcp/server/McpAccessStore.java" \
  "$ROOT/src/org/docear/plugin/mcp/server/McpPermissions.java" \
  "$ROOT/src/org/docear/plugin/mcp/server/McpAccessStandaloneTest.java"
"$JAVA_HOME/bin/java" -cp "$BUILD" org.docear.plugin.mcp.server.McpAccessStandaloneTest
